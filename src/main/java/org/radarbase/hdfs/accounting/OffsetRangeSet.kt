...
import org.radarbase.hdfs.util.FunctionalValue
import org.radarbase.hdfs.util.LockedFunctionalValue
...
class OffsetRangeSet {
    ...
    class OffsetRangeLists {
        ...
        fun stream(): Stream<LongTuple> {
            return IntStream.range(0, offsetsFrom.size())
                    .mapToObj { i -> LongTuple(offsetsFrom.get(i), offsetsTo.get(i)) }
        }
